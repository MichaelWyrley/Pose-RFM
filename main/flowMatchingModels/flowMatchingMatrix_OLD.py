# THIS is an older version of the flow matching model that wrongly uses euler to matrix instead of axis angle to matrix.
# The output of a trained model does work but the technique is not correct
# The reason it works is most likely due to the backbone model compensating for the error !!
