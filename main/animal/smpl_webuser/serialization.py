# Taken from https://github.com/Rubikplayer/flame-fitting/blob/master/smpl_webuser/serialization.py
'''
...
import numpy as np
np.bool, np.int, np.float, np.complex, np.object, np.unicode, np.str = np.bool_, np.int_, np.float_, np.complex_, np.object_, np.unicode_, np.str_
import chumpy as ch
import pickle as pickle
from chumpy.ch import MatVecMult
# from posemapper import posemap
# from verts import verts_core
from main.animal.smpl_webuser.posemapper import posemap
from main.animal.smpl_webuser.verts import verts_core
